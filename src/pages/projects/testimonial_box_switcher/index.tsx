  ...
  return (
    <div className={styles.body}>
      <div className={styles.testimonial_container}>
        ...
        {/* <div className={styles.fas fa-quote-right fa-quote}></div>
        <div className={styles.fas fa-quote-left fa-quote}></div> */}
        <p className={styles.testimonial}>{testimonials[index].text}</p>
        <div className={styles.user}>
          ...
          <div className={styles.user_details}>
            <h4 className={styles.username}>{testimonials[index].name}</h4>
            <p className={styles.role}>{testimonials[index].position}</p>
          </div>
        </div>
      </div>
    </div>
